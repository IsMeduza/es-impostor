...
const es: Dictionary = {
  ...
  'results.summary': 'Resumen de la partida',
  ...
  'ads.interstitial.body': 'Generando tu tema personalizado...',
  'ads.interstitial.btn': 'Continuar',
  ...
  'admin.totalRooms': 'Salas creadas (total)',
  'admin.publicRooms': 'Salas públicas activas',
  'admin.geminiCalls': 'Llamadas a Gemini',
  'admin.lastUpdate': 'Última actualización',
  'admin.publicRoomsList': 'Detalle de salas públicas',
  'admin.code': 'Código',
  ...
  'admin.geminiNearLimit': 'Aviso: uso de Gemini cerca del límite diario. Se usará más fallback local si se supera.'
};
...
const ca: Dictionary = {
  ...
  'results.summary': 'Resum de la partida',
  ...
  'ads.interstitial.body': 'Generant el teu tema personalitzat...',
  'ads.interstitial.btn': 'Continuar',
  ...
  // Admin panel
  'admin.title': 'Panell admin',
  'admin.pinLabel': 'PIN d\'administrador',
  'admin.pinPlaceholder': '',
  'admin.view': 'Veure estadístiques',
  ...
  'admin.totalRooms': 'Sales creades (total)',
  'admin.publicRooms': 'Sales públiques actives',
  'admin.geminiCalls': 'Crides a Gemini',
  'admin.lastUpdate': 'Última actualització',
  'admin.publicRoomsList': 'Detall de sales públiques',
  'admin.code': 'Codi',
  'admin.players': 'Jugadors',
  'admin.name': 'Nom',
  'admin.topic': 'Tema',
  'admin.ageMinutes': 'Minuts oberta',
  'admin.closeRoom': 'Tancar sala',
  'admin.closing': 'Tancant...',
  'admin.geminiNearLimit': 'Avís: ús de Gemini a prop del límit diari. S\'utilitzarà més fallback local si se supera.'
};
